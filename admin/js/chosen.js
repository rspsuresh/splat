...
//            this.addnew = options1 !=  ? options1 : {};
        ...
        AbstractChosen.prototype.keyup_checker = function (evt) {
            ...
            switch (stroke) {
                ...
                case 13:
                    evt.preventDefault();
                    if (this.options.add_new != undefined && this.options.add_new == "Y") {
                        if (this.results_showing) {
    ...
    $.fn.extend({
        chosen: function (options, addnew) {
            if (!AbstractChosen.browser_is_supported()) {
                return this;
            }
            return this.each(function (input_field) {
                ...
                if (!(chosen instanceof Chosen)) {
                    $this.data('chosen', new Chosen(this, options, addnew));
                }
            });
        }
    });
