...
<section id="wrapper" >
    ...
    <div class="container">
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12 padzero user-staff">
            ...
            ?>
            <div class="col-lg-5 col-xs-12 col-sm-4 staff-due">
                <h6><?php echo $groupusers->groups->name; ?></h6>
                <div class="col-lg-12 col-xs-12 col-sm-12 padzero">
                    <?php
                    if(count($groupusers)>0):
                        foreach($groupusers as $groupuser):
                            $iquestions = Questions::model()->count('course='.$projects->course);
                            $iassess = Assess::model()->count('project='.$projects->id.' and from_user='.Yii::app()->user->id.' and to_user='.$groupuser->user_id);
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12 padzero">
                    ...
                    <?php foreach($assesall as $key=>$val){
                        ...
                        $action=Yii::app()->CreateUrl('site/assesmentresponse',array('id'=>$projects->id,
                            'u'=>$userid,'c'=>$courseid,'g'=>$grpresult[0]['group_id'],'as'=>$val->id));
                        ...
                        <div class="col-lg-12 col-xs-12 col-sm-12 padzero" style="margin:5px;">
                            ...
                            if($assexists) { ?>
                                <a href="<?php echo $action ?>"  style="color:white !important;"><button type="button" class="btn btn-<?=$badge?>">Assessment -<?= ($key+1)?></button></a>
                            <?php }
                            else { ?>
        ...
        <div class="col-lg-12 col-xs-12 col-sm-12 padzero" style="display:<?=$showresponse?>">
            ...
            <div class="bs-example">
                                ...
                                <div id="question_<?php echo $groupuser->id;?>" class="panel-collapse collapse"
                                    ...
                                    <div class="panel-body">
                                        <div class="script-texts">
                                            ...
                                            $icomments = AssessComments::model()->find('project='.$projects->id.' and to_user='.$groupuser->user_id.' 
                                            and from_user='.Yii::app()->user->id.' and asses_id='.$activeass);

                                            $i=0;
                                            foreach($questions as $iquestion):
                                                $i++;
                                                $iassess = Assess::model()->find('project='.$projects->id.' and to_user='.$groupuser->user_id.' 
                                                and from_user='.Yii::app()->user->id.' and question='.$iquestion->id.' and asses_id='.$activeass);
                                                ?>
                ...
                /*                                            if($groupuser->user_id==Yii::app()->user->id)
                                                            ...
                                                            */?>
                                            <i class="trigger_<?/*=$key*/?> fa fa-angle-down pull-right blue-clr" aria-hidden="true"></i></a>
                                    </h4>
                                </div>
...
<script type="text/javascript">
    ...
    /*$('.panel-heading').click(function(){
        var ind=$('.panel-heading').index(this);
        $('.blue-clr').trigger('click');
    });*/
</script>