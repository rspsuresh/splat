...
class Groups extends CActiveRecord
{
    ...
    public static function ActionButtons($id) {
        ...
        $buttons .= CHtml::link('<img src="/admin/assets/f0f2f69/gridview/update.png" alt="Update">',
            Yii::app()->createUrl("groups/update",array('id'=>$id,'c'=>$_GET['c'],'i'=>$_GET['i'],'f'=>$_GET['f'])));
        $buttons .= CHtml::link('<img src="/admin/assets/f0f2f69/gridview/delete.png" alt="Delete">',
            Yii::app()->createUrl("groups/delete",array('id'=>$id,'c'=>$_GET['c'],'i'=>$_GET['i'],'f'=>$_GET['f'])),array('class'=>'linkClass','onclick'=>'return deletegroup()'));
        $buttons.="</td>";
        echo $buttons;
    ...
    {
        $buttons='<td class="button-column">';
        $buttons .= '<a href="'.Yii::app()->CreateUrl("groups/update",array('id'=>$data,'c'=>$_GET['c'],'i'=>$_GET['i'],'f'=>$_GET['f'],'p'=>$_GET['p'])).'" >
                    <button type="button" class="btn btn-warning fa fa-edit"> Edit</button></a>  ';
        $buttons .= '<a onclick="deletegroup('.$data.')"><button type="button" class="btn btn-danger fa fa-trash"> Delete</button></a>';
        $buttons.="</td>";
        echo $buttons;
    }
