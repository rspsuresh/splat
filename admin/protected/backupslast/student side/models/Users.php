...
class Users extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('username, password, first_name, last_name, course_id, institution_id, fac_id, role', 'required','on'=>'normal'),
            ...
            array('id, username, password, first_name, last_name, profile, status, created_date, updated_date, course_id, institution_id, fac_id, role', 'safe', 'on'=>'search'),
        );
    }
