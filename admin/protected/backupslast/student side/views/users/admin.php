...
<section id="wrapper" >
    ...
    <div class="container">
        ...
        <a class="admin-btn btn btn-success"  onclick="searchdiv()" id="searchbutton" href="#">Search Users</a>
        ...
        <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
                ...
                array(
                    'header'=>'Role',
                    'filter' => CHtml::dropDownlist('Users[role]', $model->role, CHtml::listData(Userrole::model()->findAll(), "id", "s_name"), array('empty'=>'select')),
