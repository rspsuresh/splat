        ...
        <div class="span12">
            <div class="thumbnail">
                <div class="hero-unit center">
                    ...
                    <?php
                    $ins_user=Admin::model()->findByPk(Yii::app()->session['id']);
                    $insbs64=base64_encode($ins_user->ins_id);
                    $facbs64=base64_encode($ins_user->fac_id);
                    $cubs64=base64_encode($ins_user->course_id);
                    if(Yii::app()->user->getState('role')==='Superuser')
                    {
                        $url=Yii::app()->createUrl('site/faculties',array('i'=>$insbs64));
                    }
                    ...
                    ?>
                    <a href="<?php echo $url; ?>" class="btn btn-large btn-info"><i class="icon-home icon-white"></i> Take Me Home</a>
                </div>
            </div>
