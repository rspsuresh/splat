...
<section style="min-height:460px"><div class="container">
    ...
    <div class="container">
        ...
        <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
                ...
                array(
                    ...
                    'type'=>'raw',
                    'htmlOptions' => array('width' => '8%'),
                    "value" => 'Groups::Actionbuttonsgroups($data->id)'
                )
                /*array(
                    'header' => 'Action',
                    'class' => 'CButtonColumn',
        ...
        Yii::app()->clientScript->registerScript('search', "
                ...
                ");
        ?>
        <h3 class="common user-assessment" style="font-size: 18px !important;"><p>Manage Multiple Assessment</p></h3>
        <p class="row-inactive">        <a href="#">
                <span class="glyphicon glyphicon-info-sign"></span>
            </a> Please activate an assessment for students to assess. Only one assessment can be active at a time.</p>
        <?php
