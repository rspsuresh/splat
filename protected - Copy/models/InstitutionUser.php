...
class InstitutionUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, institution, faculty, course', 'required'),
			array('user_id, institution, faculty, course', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, institution, faculty, course', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'group' => array(self::BELONGS_TO, 'Groupmaster', 'g_id'),
		);
	}
